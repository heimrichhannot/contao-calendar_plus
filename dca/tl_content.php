...
$dc['palettes']['promoterlist'] =
	'{type_legend},type,headline;{promoter_config_legend},cal_calendar,cal_promoterTypes,cal_promoters,cal_promoterTemplate;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
...
(
	...
	(
		...
		'options_callback' => array('tl_content_calendar_plus', 'getPromoters'),
		'eval'             => array('mandatory' => true, 'multiple' => true),
		'sql'              => "blob NULL",
	),
	'cal_promoterTemplate' => array
	(
		'label'            => &$GLOBALS['TL_LANG']['tl_module']['cal_promoterTemplate'],
		'default'          => 'cal_promoter_default',
		'exclude'          => true,
		'inputType'        => 'select',
		'options_callback' => array('tl_module_calendar_plus', 'getPromoterTemplates'),
...
class tl_content_calendar_plus extends Backend
{
	...
	public function getPromoters($dc)
	{
		...
		$objPromoters = HeimrichHannot\CalendarPlus\CalendarPromotersModel::findPublishedByPidsAndTypes(array($dc->activeRecord->cal_calendar), $arrTypes);
