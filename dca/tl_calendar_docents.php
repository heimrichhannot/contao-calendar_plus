 ...
 */
$GLOBALS['TL_DCA']['tl_calendar_docents'] = [
    ...
    'config'      => [
        ...
        'onload_callback'   => [
            ['tl_calendar_docents', 'checkPermission'],
        ],
        'onsubmit_callback' => [
    ...
    'list'        => [
        'sorting'           => [
            ...
            'child_record_callback' => ['tl_calendar_docents', 'listDocents'],
        ...
        'operations'        => [
            ...
            'toggle' => [
                ...
                'button_callback' => ['tl_calendar_docents', 'toggleIcon'],
            ],
            'show'   => [
    ...
    'fields'      => [
        ...
        'alias'     => [
            ...
            'save_callback' => [
                ['tl_calendar_docents', 'generateAlias'],
            ],
...
class tl_calendar_docents extends Backend
{
    ...
    public function generateAlias($varValue, DataContainer $dc)
    {
        ...
        $objAlias = $this->Database->prepare("SELECT id FROM tl_calendar_docents WHERE alias=?")->execute($varValue);
    ...
    public function toggleVisibility($intId, $blnVisible, DataContainer $dc = null)
    {
        ...
        // Update the database
        $this->Database->prepare("UPDATE tl_calendar_docents SET tstamp=" . time() . ", published='" . ($blnVisible ? 1 : '') . "' WHERE id=?")->execute($intId);

        $objVersions->create();
        $this->log(
            'A new version of record "tl_calendar_docents.id=' . $intId . '" has been created' . $this->getParentEntries('tl_calendar_docents', $intId),
            __METHOD__,
            TL_GENERAL
        );
    ...
    public function checkPermission()
    {
        ...
        switch (Input::get('act'))
        {
            ...
            case 'delete':
            case 'toggle':
                $objDocent = $this->Database->prepare("SELECT pid FROM tl_calendar_docents WHERE id=?")->limit(1)->execute($id);
            ...
            case 'copyAll':
                ...
                $objDocent = $this->Database->prepare("SELECT id FROM tl_calendar_docents WHERE pid=?")->execute($id);
