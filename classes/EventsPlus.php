        ...
        if (is_array($objEvent->memberDocents) && !empty($objEvent->memberDocents))
        {
            ...
            if ($objMembers !== null)
            {
                while ($objMembers->next())
                {
                    ...
                    $objMemberPlus->mlTemplate      =
                        ($arrEvent['isSubEvent'] && $this->cal_subeventDocentTemplate != '') ? $this->cal_subeventDocentTemplate : $objMemberPlus->mlTemplate;
        ...
        if (is_array($objEvent->memberHosts) && !empty($objEvent->memberHosts))
        {
            ...
            if ($objMembers !== null)
            {
                while ($objMembers->next())
                {
                    ...
                    // custom subevent memberlist template
                    $objMemberPlus->mlTemplate    =
                        ($arrEvent['isSubEvent'] && $this->cal_subeventHostTemplate != '') ? $this->cal_subeventHostTemplate : $objMemberPlus->mlTemplate;
