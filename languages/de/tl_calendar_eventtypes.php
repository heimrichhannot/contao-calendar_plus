 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_calendar_eventtypes']['new']    = array('Neue Veranstaltungsart', 'Eine neue Veranstaltungsart erstellen.');
$GLOBALS['TL_LANG']['tl_calendar_eventtypes']['show']   = array('Veranstaltungsartdetails', 'Details der Veranstaltungsart ID %s anzeigen');
$GLOBALS['TL_LANG']['tl_calendar_eventtypes']['edit']   = array('Veranstaltungsart bearbeiten ', 'Veranstaltungsart ID %s bearbeiten');
$GLOBALS['TL_LANG']['tl_calendar_eventtypes']['cut']    = array('Veranstaltungsart verschieben', 'Verschieben der Veranstaltungsart ID %s');
$GLOBALS['TL_LANG']['tl_calendar_eventtypes']['copy']   = array('Veranstaltungsart kopieren ', 'Kopieren de Veranstaltungsart ID %s');
$GLOBALS['TL_LANG']['tl_calendar_eventtypes']['delete'] = array('Veranstaltungsart löschen', 'Löschen der Veranstaltungsart ID %s');