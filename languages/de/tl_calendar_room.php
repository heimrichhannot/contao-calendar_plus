 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_calendar_room']['new']    = ['Neuer Eventraum', 'Eventraum erstellen'];
$GLOBALS['TL_LANG']['tl_calendar_room']['edit']   = ['Eventraum bearbeiten', 'Eventraum ID %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_calendar_room']['copy']   = ['Eventraum duplizieren', 'Eventraum ID %s duplizieren'];
$GLOBALS['TL_LANG']['tl_calendar_room']['delete'] = ['Eventraum löschen', 'Eventraum ID %s löschen'];
$GLOBALS['TL_LANG']['tl_calendar_room']['toggle'] = ['Eventraum veröffentlichen', 'Eventraum ID %s veröffentlichen/verstecken'];
$GLOBALS['TL_LANG']['tl_calendar_room']['show']   = ['Eventraum Details', 'Eventraum-Details ID %s anzeigen'];
